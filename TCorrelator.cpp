...
int TCorrelator::Correlate(TBetaDecayParams &bdecay, TBetaDecayVariables &bdecayv)
{
  ...
  if(isImplant)
	...
	{ // We have a good position
	  ...
	  // double tdiff_sega[nsega];
	  // //Energy condition
	  // for(int det = 0; det < nsega; det ++){
	  //   if(bdecay.sega.ecal[det] > 10){
	  //     tdiff_sega[det] = bdecay.sega.time[det]-gImplant[xPos][yPos].time;	  
	  //     bdecay.corr.sega_implant_tdiff[det] = tdiff_sega[det];
	  //     bdecay.corr.sega_implant_itofpin01i2s[det] = gImplant[xPos][yPos].tofpin01i2s;
	  //     bdecay.corr.sega_implant_idE1[det] = gImplant[xPos][yPos].dE1;
	  //   }
	  // }
	  ...
	  //Position independent
	  // double tdiff_labr3[nlabr3];
	  // //Energy condition
	  // for(int det = 0; det < nlabr3; det ++){
	  //   if(bdecay.labr3.ecal[det] > 10){
	  //     tdiff_labr3[det] = bdecay.labr3.time[det]-gImplant[xPos][yPos].time;	  
	  //     bdecay.corr.labr3_implant_tdiff[det] = tdiff_labr3[det];
	  //     bdecay.corr.labr3_implant_itofpin01i2s[det] = gImplant[xPos][yPos].tofpin01i2s;
	  //     bdecay.corr.labr3_implant_idE1[det] = gImplant[xPos][yPos].dE1;
	  //   }
	  // }
	...
	if(bdecay.sega.ecal[det] > 10){
	  for(int xg = 0; xg < npspmt; xg++){
	    for(int yg = 0; yg < npspmt; yg++){
	      ...
	      bdecay.corr.sega_implant_tdiff[det][xg][yg] = tdiff_sega[det][xg][yg];
	      bdecay.corr.sega_implant_itofpin01i2s[det][xg][yg] = gImplant[xg][yg].tofpin01i2s;
	      bdecay.corr.sega_implant_idE1[det][xg][yg] = gImplant[xg][yg].dE1;
	    }
	  }
	}
      }
      ...
      // 	  for(int xg = 0; xg < npspmt; xg++){
      // 	    for(int yg = 0; yg < npspmt; yg++){
      // 	      tdiff_sega[det] = bdecay.sega.time[det]-gImplant[xg][yg].time;	  
      // 	      bdecay.corr.sega_implant_tdiff[det] = tdiff_sega[det];
      // 	      bdecay.corr.sega_implant_itofpin01i2s[det] = gImplant[xg][yg].tofpin01i2s;
      // 	      bdecay.corr.sega_implant_idE1[det] = gImplant[xg][yg].dE1;
      // 	    }
      // 	  }
      // 	}
      // }
	...
	if(bdecay.labr3.ecal[det] > 10){
	  for(int xg = 0; xg < npspmt; xg++){
	    for(int yg = 0; yg < npspmt; yg++){
	      ...
	      bdecay.corr.labr3_implant_tdiff[det][xg][yg] = tdiff_labr3[det][xg][yg];
	      bdecay.corr.labr3_implant_itofpin01i2s[det][xg][yg] = gImplant[xg][yg].tofpin01i2s;
	      bdecay.corr.labr3_implant_idE1[det][xg][yg] = gImplant[xg][yg].dE1;
	    }
	  }
	}
      }
      ...
      // 	  for(int xg = 0; xg < npspmt; xg++){
      // 	    for(int yg = 0; yg < npspmt; yg++){
      // 	      tdiff_labr3[det] = bdecay.labr3.time[det]-gImplant[xg][yg].time;	  
      // 	      bdecay.corr.labr3_implant_tdiff[det] = tdiff_labr3[det];
      // 	      bdecay.corr.labr3_implant_itofpin01i2s[det] = gImplant[xg][yg].tofpin01i2s;
      // 	      bdecay.corr.labr3_implant_idE1[det] = gImplant[xg][yg].dE1;
      // 	    }
      // 	  }
      // 	}
      // }
