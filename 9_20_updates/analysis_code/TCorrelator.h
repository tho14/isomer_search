...
//TO 09/12/22
class TImplantIsomer
{
 public:
  double time;        // dynode time
  double dE1;         // dE from Pin01
  double tofpin01i2s; // Time of flight Pin01-I2S
...
class TCorrelator
{
 ...
 private:
  ...
  TImplantIsomer gImplant[npspmt][npspmt];//Creating new implant search (for isomer hunting)
  TSegaImplant sImplant[npspmt][npspmt];//Creating new implant search (for isomer hunting)
  TLabr3Implant lImplant[npspmt][npspmt];//Creating new implant search (for isomer hunting)
