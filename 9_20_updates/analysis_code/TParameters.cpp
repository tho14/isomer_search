...
void TCorrelatorData::Reset()
{
  ...
  for(int i = 0; i < nsega; i++){
    for(int j = 0; j < npspmt; j++){
  	...
  	sega_dynode_tdiff[i][j][k] = {0};
  	sega_dynode_idE1[i][j][k] =  {0};
  	sega_dynode_itofpin01i2s[i][j][k] =  {0};
      }
    }
   }
  ...
  //   for(int j = 0; j < npspmt; j++){
  //     for(int k = 0; k < npspmt; k++){
  // 	sega_implant_tdiff[i] = {0};
  // 	sega_implant_idE1[i] =  {0};
  // 	sega_implant_itofpin01i2s[i] =  {0};
  //     }
  //   }
  // }
  ...
  sde1 = 0;
  stofpin01i2s = 0;
  labr3_implant_time = 0;
  labr3_implant_dt = 0;
  for(int i = 0; i < nlabr3; i++){
    for(int j = 0; j < npspmt; j++){
      for(int k = 0; k < npspmt; k++){
  	labr3_dynode_tdiff[i][j][k] =  {0};
    	labr3_dynode_idE1[i][j][k] =  {0};
  	labr3_dynode_itofpin01i2s[i][j][k] =  {0};
      }
    }
  }
  ...
  //Position independent
  // for(int i = 0; i < nlabr3; i++){
  // 	labr3_implant_tdiff[i] =  {0};
  //   	labr3_implant_idE1[i] =  {0};
  // 	labr3_implant_itofpin01i2s[i] =  {0};
  // }
