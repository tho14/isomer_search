...
// Fri Sep 16 17:15:43 2022 by ROOT version 6.10/02
// from TTree data/data
// found on file: run-0172-00-e16032_analysis_tho.root
//////////////////////////////////////////////////////////
...
public :
   ...
   double halflife[nblob];
   TCutG *cut[nblob] = {};

   TH2D* hsegaecal_tdiff[nblob] = {nullptr};
   TH2D* hlabr3ecal_tdiff[nblob] = {nullptr};

   TH2D* hsegaecal_tdiff_det[nblob] = {nullptr};
   TH2D* hlabr3ecal_tdiff_det[nblob] = {nullptr};

   TH2D* hsegaecal_tdiff_det_imp[nblob] = {nullptr};
   TH2D* hlabr3ecal_tdiff_det_imp[nblob] = {nullptr};
   ...
   TTreeReaderValue<Double_t> corr_gde1 = {fReader, "corr.gde1"};
   TTreeReaderValue<Double_t> corr_gtofpin01i2s = {fReader, "corr.gtofpin01i2s"};
   ...
   TTreeReaderValue<Double_t> corr_sde1 = {fReader, "corr.sde1"};
   TTreeReaderValue<Double_t> corr_stofpin01i2s = {fReader, "corr.stofpin01i2s"};
   TTreeReaderValue<Double_t> corr_sega_implant_time = {fReader, "corr.sega_implant_time"};
   TTreeReaderValue<Double_t> corr_sega_implant_dt = {fReader, "corr.sega_implant_dt"};
   TTreeReaderArray<Double_t> corr_sega_dynode_tdiff = {fReader, "corr.sega_dynode_tdiff[16][16][16]"};
   TTreeReaderArray<Double_t> corr_sega_dynode_idE1 = {fReader, "corr.sega_dynode_idE1[16][16][16]"};
   TTreeReaderArray<Double_t> corr_sega_dynode_itofpin01i2s = {fReader, "corr.sega_dynode_itofpin01i2s[16][16][16]"};
   TTreeReaderValue<Double_t> corr_lde1 = {fReader, "corr.lde1"};
   TTreeReaderValue<Double_t> corr_ltofpin01i2s = {fReader, "corr.ltofpin01i2s"};
   TTreeReaderValue<Double_t> corr_labr3_implant_time = {fReader, "corr.labr3_implant_time"};
   TTreeReaderValue<Double_t> corr_labr3_implant_dt = {fReader, "corr.labr3_implant_dt"};
   TTreeReaderArray<Double_t> corr_labr3_dynode_tdiff = {fReader, "corr.labr3_dynode_tdiff[15][16][16]"};
   TTreeReaderArray<Double_t> corr_labr3_dynode_idE1 = {fReader, "corr.labr3_dynode_idE1[15][16][16]"};
   TTreeReaderArray<Double_t> corr_labr3_dynode_itofpin01i2s = {fReader, "corr.labr3_dynode_itofpin01i2s[15][16][16]"};
   ...
   TTreeReaderValue<Int_t> corr_isimplantisomer = {fReader, "corr.isimplantisomer"};
   ...
   TTreeReaderArray<Double_t> sega_timecfd = {fReader, "sega.timecfd[16]"};
   TTreeReaderArray<Int_t> sega_cfdfailbit = {fReader, "sega.cfdfailbit[16]"};
